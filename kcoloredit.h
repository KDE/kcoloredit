...
/**
  ...
  * KColorEditApp reimplements the methods that KXmlGuiWindow provides for main window handling and supports
  ...
  */
class KColorEditApp : public KXmlGuiWindow
{
  Q_OBJECT
  ...
  public:
    ...
    /** returns a pointer to the current document connected to the KXmlGuiWindow instance and is used by
